...
--- version 0.3.192 --- 20.03.2026
Changes:
- import from .txt
- import from .csv
- import from .pdf
- duplicate handling — Skip / Replace / Keep all (radio buttons with descriptions)

Bug fixed:
-


--- version 0.3.201 --- 21.03.2026
Changes:
- share panel with more possible choosen option
- save to pc
- open file
- show folder
- copy path
...
--- version 0.3.215 --- 22.03.2026
Changes:
- added the notification
- overdue - red toast, critical urgency (task is past its due date)
- due today — blue toast, normal urgency
- upcoming tomorrow — green toast, low urgency
- due within 3 days — green toast, low urgency
- added all the notification option in the setting
- setting to show notification overdue
- setting to show notification due today
- setting to show notification upcoming tomorrow
- setting to show notification due within 3 days
- scrollable left side bar
- scrollbar on the left for better grphic
- scrollbar with the same graphic of the scrollbar in the Tasks window

Bug fixed:
- overdue counter in the left sidebar was showing all the overdue task, done and not done yet


--- version 0.3.216 --- 23.03.2026
Changes:
- weekly Heatmap added to the GUI

Bug fixed:
-

--- version 0.3.202 --- 24.03.2026
Changes:
- 
